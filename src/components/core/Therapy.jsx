          ...
          <Card>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" textAlign="center">
                Make a mess of your stress! The goal of the game is to destroy your stress beyond repair.
              </Typography>
              <div style={{ display: "flex", justifyContent: "center", marginTop: "10px" }}>
                <Link to={'https://mindyourmind.ca/apps/StressMeLess/index.html'}>
        ...
        <Grid item xs={12} sm={6} md={5}>
          <Card>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" textAlign="center">
                Squish, match, or pop your way to relieve stress in this fun and engaging game.
              </Typography>
              <div style={{ display: "flex", justifyContent: "center", marginTop: "10px" }}>
                <Link to={'https://mindyourmind.ca/apps/squishem_2023/index.html'}>
                    <Button variant="outlined" className="button">
                        Take Therapy
                    </Button>
                </Link>
        ...
        <Grid item xs={12} sm={6} md={5}>
          <Card>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" textAlign="center">
                This game should help you cope in different situations where you might experience anxiety.
              </Typography>
              <div style={{ display: "flex", justifyContent: "center", marginTop: "10px" }}>
                <Link to={'https://mindyourmind.ca/apps/Monstressity/'}>
                    <Button variant="outlined" className="button">
                        Take Therapy
                    </Button>
                </Link>
        ...
        <Grid item xs={12} sm={6} md={5}>
          <Card>
            ...
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" textAlign="center">
                Relax and Engage in a gentle experience designed to calm your mind and relieve stress.
              </Typography>
              <div style={{ display: "flex", justifyContent: "center", marginTop: "10px" }}>
                <Link to={'https://mindyourmind.ca/apps/QuoteBloom/en/story_html5.html'}>
                    <Button variant="outlined" className="button">
                        Take Therapy
                    </Button>
                </Link>
